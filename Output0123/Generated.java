...
public Function1<Integer, Integer> apply(   ) { 
...
public Function2<Double, Double, Boolean> apply(   ) { 
...
;
 ...
 class fib implements Function1< final Integer, Integer> { 
public fib(){} 
 
public Integer apply(  Integer n ) { 
final Integer[] a = new Integer[1];
final Integer[] b = new Integer[1];
a[0] = new Async<Integer>() { 
 public void run() { 
new fib().apply(n  -  1) ;
 } 
 }.getValue();;
b[0] = new Async<Integer>() { 
 public void run() { 
new fib().apply(n  -  2) ;
 } 
 }.getValue();;
